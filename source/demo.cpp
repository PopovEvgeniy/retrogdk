...
{
 char perfomance[8];
 RETROGDK::Backlight light;
 RETROGDK::Screen screen;
 RETROGDK::Gamepad gamepad;
 RETROGDK::Sound sound;
 RETROGDK::Audio audio;
 RETROGDK::Player player;
 RETROGDK::Timer timer;
 RETROGDK::Image image;
 RETROGDK::Background space;
 RETROGDK::Sprite ship,font;
 RETROGDK::Text text;
 screen.initialize();
